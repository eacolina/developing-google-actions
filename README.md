...
**NOTE:** The following documentation assumes that you have read the [Developing Amazon Alexa Skills TODO add link]() documentation, hence the explanation will be less detailed here.
...
- [Creating a Google Action](#creating-a-google-action)
  ...
  - [Step 2: Creating the Interaction Model using API.ai](#step-2-creating-the-interaction-model-using-api-ai)
      - [Creating the Agent](#creating-an-agent)
      - [Intents](#intents)
      - [Fulfillment](#fulfillment)
  - [Step 3: Enable your agent in Google Actions](#step-3-enabling-your-agent-in-google-actions)
  - [Step 4: Setting up your web hook in Meteor using Express](#step-4-setting-up-your-webhook-in-meteor)
  - [Step 5: Web Hook Code](#step-5-web-hook-code)
        - [Creating an endpoint in Express](#creating-an-endpoint-in-express)
        - [Handler and Action Map](#handler-and-action-map)
        - [Getting the value of a parameter](#getting-the-value-of-a-parameter)
        - [Sending a response back to the user](#sending-a-response-back-to-the-user)
